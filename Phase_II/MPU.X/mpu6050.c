...
// Defines for MPU6050 internal registers
#define MPU6050_WR_ADDRESS          0xD0
#define MPU6050_RD_ADDRESS          0xD1
...
void init_MPU(void){
    ...
    //set sensitivity of the gyro
    writeBits(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_GYRO_CONFIG, MPU6050_GCONFIG_FS_SEL_BIT, MPU6050_GCONFIG_FS_SEL_LENGTH, MPU6050_GYRO_FS_1000);

    //set sensitivity of the accel
    writeBits(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_ACCEL_CONFIG, MPU6050_ACONFIG_AFS_SEL_BIT, MPU6050_ACONFIG_AFS_SEL_LENGTH, MPU6050_ACCEL_FS_8);

    //set sleep bit to 0( wake up device)
    writeBit(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_PWR_MGMT_1, MPU6050_PWR1_SLEEP_BIT, 0);
}
...
int16_t getXAccelOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_XA_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
void setXAccelOffset(int16_t offset) {
    uint8_t  temp[2] = {offset >>8 , offset};
    writeBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_XA_OFFS_H,2, temp);
}
...
int16_t getYAccelOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_YA_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t getZAccelOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_ZA_OFFS_H, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t getXGyroOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_XG_OFFS_USRH, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t getYGyroOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_YG_OFFS_USRH, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
...
int16_t getZGyroOffset() {
    uint8_t buffer[2];
    readBytes(MPU6050_DEFAULT_ADDRESS, MPU6050_RA_ZG_OFFS_USRH, 2, buffer);
    return (((int16_t)buffer[0]) << 8) | buffer[1];
}
