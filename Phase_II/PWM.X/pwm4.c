 ...
 * \date   Created on on May 6, 2018, 9:30 AM
 */
...
void output_compare_4_init(void) 
{
    ...
    DISABLE_OUTPUT_COMPARE_PERIPHERAL_4;     // Disable PWM output pin while doing the setup now
...
uint8_t set_PWM4_duty_cycle(uint8_t duty_cycle) 
{
    ...
    OC4RS = (uint16_t) (new_OC4RS & 0x0000FFFF);
